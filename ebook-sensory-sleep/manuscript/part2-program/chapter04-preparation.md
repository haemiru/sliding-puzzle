...
*추천 에센셜 오일 3종 — 라벤더, 캐모마일, 만다린*

| 오일 | 특징 | 추천 상황 |
|------|------|-----------|
| **라벤더** | 가장 대표적인 수면 도우미. 부드럽고 꽃 향. | 모든 아이에게 기본 추천 |
| **캐모마일** | 달콤하고 따뜻한 향. 진정 효과 탁월. | 불안감이 높은 아이 |
| **만다린** | 상큼하고 과일 향. 아이들이 가장 잘 받아들임. | 향기에 거부감 있는 아이 |
...
**온도**
수면에 이상적인 실내 온도는 **18~22도**입니다. 너무 덥거나 추우면 잠들기 어렵습니다.
- □ 방에 온도계를 비치했나요?
- □ 계절별 온도 조절 방법(에어컨, 히터, 환기)을 확인했나요?

**조명**
잠들기 1시간 전부터 조명을 단계적으로 낮춰야 합니다. 밝은 빛, 특히 스마트폰이나 TV의 블루라이트는 수면 호르몬(멜라토닌)을 억제합니다.
- □ 밝은 조명 → 어두운 조명으로 단계적 전환이 가능한가요?
- □ 스크린(TV, 태블릿, 스마트폰)은 최소 1시간 전에 끌 수 있나요?
- □ 야간 조명은 따뜻한 색(주황/노랑), 낮은 밝기인가요?

**소음**
- □ 외부 소음이 들어오는 곳(창문, 문 틈새)을 확인했나요?
- □ 필요하다면 화이트 노이즈 기기를 고려해보세요

### 훈련 공간 만들기

![이상적인 훈련 공간 배치도](../../images/diagrams/diagram04-room-layout.png)
*훈련 공간 배치 — 디퓨저는 침대에서 1~2m 거리, 호흡 도구 바구니는 손 닿는 곳에*

- **디퓨저 위치**: 침대에서 1~2m 거리. 아이 얼굴에 직접 향하지 않도록 합니다
- **편안한 공간**: 아이가 앉거나 누울 수 있는 쿠션이나 매트
- **도구 바구니**: 호흡 훈련 도구를 한곳에 모아 두세요. 매일 꺼내고 정리하는 것도 루틴의 일부가 됩니다
- **시계**: 훈련 시간을 확인하되, 아이가 볼 수 없는 위치에 놓으세요 (시간 압박감 방지)
...
각 오일마다 별도로 테스트하세요. 라벤더에 괜찮아도 캐모마일에 반응이 있을 수 있습니다.
